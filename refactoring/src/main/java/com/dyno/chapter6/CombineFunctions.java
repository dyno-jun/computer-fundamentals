...
// 테스트 코드
class CombineFunctionsTest {
  public static void main(String[] args) {
    EmployeeData employeeData = new EmployeeData("John Doe", 50.0, 160, 5); // 이름, 시급, 근무 시간, 성과 평점
    CombineFunctions combineFunctions = new CombineFunctions();
    combineFunctions.printEmployeeDetails(employeeData);
  }
}
